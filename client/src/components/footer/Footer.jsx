    ...
    return (
        <footer className={styles.footer}>
            <div className={styles.footer__container}>
                ...
                <div className={styles.footer__section}>
                    ...
                    <ul className={styles.footer__links}>
                        <li><a href="#performers">Performers Page</a></li>
                ...
                <div className={styles.footer__section}>
                    ...
                    <div className={styles.footer__social}>
                        ...
                        <a href="#" className={styles.social__link} aria-label="TikTok">
                            <svg viewBox="0 0 24 24" fill="currentColor">
                ...
                <div className={styles.footer__section}>
                    ...
                    <div className={styles.footer__contact}>
                        <p>📧 info@desirehub.com</p>
                        <p>📞 +1 (555) 123-4567</p>
                        <p>📍 123 Entertainment Ave, City, State 12345</p>
                    </div>
                </div>
            </div>
            ...
            <div className={styles.footer__bottom}>
                <div className={styles.footer__container}>
                    <p>&copy; 2024 DesireHub. All rights reserved.</p>
