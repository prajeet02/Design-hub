...
const Navbar = () => {
  ...
  return (
    <header className={`${styles.navbar__header} ${isScrolled ? styles.scrolled : ''}`}>  
      <div className={styles.navbar__container}>
        <div className={`${styles.navbar__section} ${styles.navbar__left}${isScrolled ? ` ${styles.scrolled}` : ''}`}>
        ...
        <div className={`${styles.navbar__section} ${styles.navbar__center}`}>
          <div className={`${styles.logo}${isScrolled ? ` ${styles.shrink}` : ''}`}>
        ...
        <div className={`${styles.navbar__section} ${styles.navbar__right}${isScrolled ? ` ${styles.scrolled}` : ''}`}>
